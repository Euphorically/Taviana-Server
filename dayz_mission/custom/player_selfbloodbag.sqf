...
_infectedLifeLost = 0; // Amount of life to loose in becomes infected

_humanityBool = true; // Whether the player can get humanity from giving self a bloodbag (True = On | False = off)
_humanityAmount = 150; // Amount of humanity to give player if _humanityBool is true (250 is default for normal bloodbags)
