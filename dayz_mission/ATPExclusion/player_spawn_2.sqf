...
while {true} do {
	...
	*/
	...
	// This is easily averted with injection. Unfortunately that was true before I made this change.
	_adminMapTP = player getVariable["adminMapTP",0];
	if (!isNil "_mylastPos") then {
