scriptName "custom\fn_selfActions.sqf";
/***********************************************************
...
///////////////////////////////////////////////////////////////////////////
	// Remove Clothes by Churchie and Co.
...
if (hasShield) then {
    ...
    zombieShield = player addAction [("<t color=""#00c362"">" + ("Anti-Zombie Freq Emitter") +"</t>"),"custom\zombieshield.sqf","",5,false,true,"",""];
    };
} else {
